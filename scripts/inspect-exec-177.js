...
async function inspect177() {
  const res = await fetch(`https://edvision.app.n8n.cloud/api/v1/executions/177?includeData=true`, {
    headers: {
  ...
  console.log(`Fetched ${companies.length} companies in execution #177.`);
